...
public class Validation {
     ...
     *
     * @param field The text field that the validation is applied to
     */
     ...
     * @param spinner   Spinner that validation is applied to
     */
    ...
    /**
     * If current health is set above max health, prompt user if they want to increase max health. This is
     * implemented just in-case the user levels up their health in the normal health field instead of max health field
     * @param health        Current character health
     * @param maxHealth     Current character max health
     */
